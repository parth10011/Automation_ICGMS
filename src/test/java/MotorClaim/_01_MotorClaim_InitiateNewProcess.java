...
//		Reporter.log("Random Car Number : " + randomCarRegistration);
		...
		WebElement Insurer = driver.findElement(By.xpath("//*[@id=\"main-wrapper\"]/div[1]/div/app-claim-intimation/div[1]/div/div/div[3]/div/div/select"));
			...
			driver.findElement(By.xpath("//input[contains(@placeholder,'Enter Make')]")).sendKeys("Check");
			driver.findElement(By.xpath("//input[contains(@placeholder,'Enter Model')]")).sendKeys("Email Veri");
			driver.findElement(By.xpath("//input[contains(@placeholder,'Enter Type')]")).sendKeys("fication");
